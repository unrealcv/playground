...
UNREALROOTPATH = "/home/qiuwch/workspace/UnrealEngine"
GAMEPROJECTFILE =/home/qiuwch/unrealcv/playground/playground.uproject
...
TARGETS = \
	...
	playground-Linux-Debug  \
	playground-Linux-DebugGame  \
	playground-Linux-Shipping  \
	playground-Linux-Test  \
	playground \
	playgroundEditor-Linux-Debug  \
	playgroundEditor-Linux-DebugGame  \
	playgroundEditor-Linux-Shipping  \
	playgroundEditor-Linux-Test  \
	playgroundEditor\
	configure
...
playground-Linux-Debug:
	 $(PROJECTBUILD) playground Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

playground-Linux-DebugGame:
	 $(PROJECTBUILD) playground Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

playground-Linux-Shipping:
	 $(PROJECTBUILD) playground Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

playground-Linux-Test:
	 $(PROJECTBUILD) playground Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

playground:
	 $(PROJECTBUILD) playground Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

playgroundEditor-Linux-Debug:
	 $(PROJECTBUILD) playgroundEditor Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

playgroundEditor-Linux-DebugGame:
	 $(PROJECTBUILD) playgroundEditor Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

playgroundEditor-Linux-Shipping:
	 $(PROJECTBUILD) playgroundEditor Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

playgroundEditor-Linux-Test:
	 $(PROJECTBUILD) playgroundEditor Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

playgroundEditor:
	 $(PROJECTBUILD) playgroundEditor Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

configure:
	xbuild /property:Configuration=Development /property:TargetFrameworkVersion=v4.0 /verbosity:quiet /nologo $(UNREALROOTPATH)/Engine/Source/Programs/UnrealBuildTool/UnrealBuildTool.csproj
	$(PROJECTBUILD) -makefile -qmakefile -cmakefile -project="\"$(GAMEPROJECTFILE)\"" -game -engine 
